...
**Commit:** `b79ac31` — feat(strombringer): Thor config app-picker for installer spoof

**Build:** `./gradlew :app:assembleDebug` → BUILD SUCCESSFUL in 2s.

## What changed
Replaced the entire contents of
`app/src/main/java/com/valhalla/thor/ext/strombringer/StrombringerExtension.kt`
