...
/**
 * A faithful copy of Thor's "Asgardian" theme so Strombringer's config UI (which runs in this
 ...
 * carries them and [StrombringerTheme] applies the same logic as Thor's ThorTheme(). Keep the color
 ...
 */
@Composable
fun StrombringerTheme(args: ThemeArgs?, content: @Composable () -> Unit) {
