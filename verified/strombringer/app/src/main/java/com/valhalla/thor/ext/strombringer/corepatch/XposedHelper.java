...
public class XposedHelper {
    ...
    public static final String TAG = "Strombringer/CorePatch";

    /** Debug logging is compiled out — never log from a system_server hook in release. */
    protected static final boolean DEBUG = false;

    /** Prefix of the single per-fire "Strombringer log" line emitted when a bypass actually fires. */
    private static final String BYPASS_LOG_PREFIX = "Strombringer[corepatch] bypassed ";
    ...
    /** Emits the single Strombringer bypass log line for [hookName]. Fail-safe; call only on a fire. */
