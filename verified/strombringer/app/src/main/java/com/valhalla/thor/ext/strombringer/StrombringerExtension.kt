...
/**
 * Thor-side metadata surface for Strombringer. Thor loads THIS class in its own process (via
 ...
 * (action `com.valhalla.thor.extension.action.CONFIGURE`) so it runs in Strombringer's OWN process
 ...
 */
class StrombringerExtension : ThorExtension {
