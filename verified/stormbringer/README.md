...
(`com.valhalla.thor.ext.stormbringer`). It has no launcher icon — install it, enable it in LSPosed,
and configure it from **Thor → Extensions → Stormbringer**.

## Features

- **Auto-unfreeze on launch** — tap a *suspended* app's real launcher icon and Stormbringer asks
...
Stormbringer is licensed under the **GNU General Public License, version 2 (GPLv2)**. See
