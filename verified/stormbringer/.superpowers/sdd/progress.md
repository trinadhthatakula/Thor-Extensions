# Stormbringer installer-spoof (Plan 2) — ledger
Repo: StudioProjects/Stormbringer (main). Plan: docs/plans/2026-07-07-installer-spoof.md
...
with Play" already covers that case. Reverted to clean auto-unfreeze-only Stormbringer.
